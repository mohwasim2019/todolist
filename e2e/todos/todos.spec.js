  ...
  describe('todos: ', function () {
    ...
    describe('on toggling todo priority',function(){
      ...
      it('should change the priority to high and mark it with a high priority icon', function(done){
        var todoElTogglePriority = page.todoEls.get(0);
        browser.actions().mouseMove(todoElTogglePriority).perform();
        var highPriorityToggleEl = todoElTogglePriority.element(by.css('.high-priority'));
